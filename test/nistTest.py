...
class NISTTest(unittest.TestCase):
    ...
    def test_NIST1(self):
        ...
        """
        case = {"l": 128, "digestmod": "sha1", "ki": None, "fixedInput": None, "ko": None}
        ...
        self._test_using_hmac_library( case )
        self._test_using_crypto_library( case )
    ...
    def test_NIST3(self):
        ...
        """
        case = {"l": 512, "digestmod": "sha1", "ki": None, "fixedInput": None, "ko": None}
    ...
    def test_NIST4(self):
        ...
        """
        case = {"l": 128, "digestmod": "sha256", "ki": None, "fixedInput": None, "ko": None}
    ...
    def test_NIST5(self):
        ...
        """
        case = {"l": 512, "digestmod": "sha256", "ki": None, "fixedInput": None, "ko": None}
    ...
    def test_NIST6(self):
        ...
        """
        case = {"l": 160, "digestmod": "sha256", "ki": None, "fixedInput": None, "ko": None}
    ...
    def test_NIST7(self):
        ...
        """
        case = {"l": 560, "digestmod": "sha256", "ki": None, "fixedInput": None, "ko": None}
